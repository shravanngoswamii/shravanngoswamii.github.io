...
\left.
\begin{aligned}
&\text{1. Fork the repository.} \\
&\text{2. Create a new branch: } \texttt{git checkout -b feature-branch} \\
&\text{3. Commit your changes: } \texttt{git commit -m "Description of changes"} \\
&\text{4. Push to the branch: } \texttt{git push origin feature-branch} \\
&\text{5. Open a pull request. } \textcolor{red}{\text{(please don't)}} \\
&\text{Boom! You have completed the ancient ritual of open source} \\
&\text{contribution. (Please don’t abuse this power.)}
\end{aligned}
\right\}
\quad
\text{This is all required to do open source contribution}
```
